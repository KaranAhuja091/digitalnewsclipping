...
keywords_list = ["China", "USA", "India", "Bagladesh", "UK", "Lanka", "AFGHANISTAN", "MALDIVES", "MAURITIUS", "TIBET", "IRAN", "ISIS", "AL-QAEDA", "AL-SHABAAB",
...
journal_list = ["INDIAN EXPRESS", "The Hindu", "Times of India", "sundayguardianlive", "sundaystandard", "hindustantimes", "dailypioneer", "thestatesman", "tribuneindia", "business-standard",
               "jagran", "jansatta", "thestatesman", "deccanherald", "asianage", "economictimes.indiatime",
...
ignore_topic_list = ['hockey', 'cricket', "Bollywood", "Hollywood", "Box office", "Asia Cup", "Games", "sport", "Fashion", "Degree", "Grammy", "Asian Games","Cloud Computing"]
